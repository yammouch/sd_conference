...
\author{\normalsize
 \begin{tabular}[t]{c@{\extracolsep{8em}}c}
  \large Takuya Yamauchi & \large Tetsuro Okura \\
  \\
   Design Center Tokyo     & Design Center Tokyo \\
   ams Japan Co. Ltd.      & ams Japan Co. Ltd. \\
   Tokyo 108-0075, Japan   & Tokyo 108-0075, Japan \\
   Takuya.Yamauchi@ams.com & Tetsuro.Okura@ams.com
%\\
%\\
%\\
%\\
...
\begin{figure*}[!tp]
 \begin{center}
  \begin{minipage}{\hsize}
   \includegraphics[width=\hsize]{fig/layers_02.eps}
...
\begin{figure}[!tb]
 \begin{center}
  \begin{minipage}{\hsize}
   \includegraphics[width=\hsize]{fig/layer_convolutional_01.eps}
...
\begin{figure}[!tb]
 \begin{center}
  \begin{minipage}{\hsize}
   \includegraphics[width=\hsize]{fig/curves_01.eps}
...
with addition of an offset vector
$\theta_{i,\textrm{\footnotesize offset}}$ as follows:
\begin{eqnarray}
z_i = \sum_{j} \theta_{i,j}\, x_{j} + \theta_{i,\textrm{\footnotesize offset}}
\end{eqnarray}

\begin{figure}[!tp]
 \begin{center}
  \begin{minipage}{\hsize}
   \includegraphics[width=\hsize]{fig/partial_softmax_01.eps}
...
For our application where a 32-length output vector could be split
...
\begin{figure}[!tp]
  \begin{minipage}{\hsize}
 \begin{center}
   \includegraphics[width=0.8\hsize]{fig/training_data_02.eps}
...
\begin{figure}[!tp]
 \begin{center}
  \begin{minipage}{\hsize}
   \includegraphics[width=\hsize]{fig/edit_steps_01.eps}
...
were split into 12 and 24 patterns.
The formar 12 patterns were used for training,
and the latter 24 pattern were used for test of learning result
and its perfomance to edit schematics.
...
\begin{figure}[!tp]
 \begin{center}
  \begin{minipage}{\hsize}
   \includegraphics[width=\hsize]{fig/test_data_02.eps}
   \caption{(a) convergence of learning,
    (b) success rate of making schematics aesthetic.}
   \label{fig:test_data}
  \end{minipage}
 \end{center}
\end{figure}

Figure \ref{fig:test_data} (a) shows an error
...
result of which is shown in Fig.\ \ref{fig:test_data} (b).
